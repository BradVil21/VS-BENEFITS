...
TRADES=[
 ...
 ('/group-health-insurance-for-general-contractors','General contractors and CM firms',
  'Your subs are not your employees. The group is the office - PMs, estimators, supers - and that is an easier case than owners expect.'),
 ('/group-health-insurance-for-structural-steel-contractors','Structural steel and erection',
  'Prevailing-wage fringe credits, multi-state crews, and why a high hazard class does not raise the medical rate.'),
 ('/group-health-insurance-for-concrete-contractors','Concrete contractors',
  'Headcount that swings with the pour schedule, bilingual enrollment, and the waiting period that keeps a plan alive through a season.'),
 ('/group-health-insurance-for-foundation-contractors','Foundation, piling and shoring',
  'Small specialist crews where one departure stops production. High wages make the affordability math easy.'),
 ('/group-health-insurance-for-excavation-contractors','Excavation and site prep',
  'Half construction, half transportation. Your operators hold CDLs, which puts the DOT physical inside your benefits decision.'),
 ('/group-health-insurance-for-demolition-contractors','Demolition contractors',
  'Where OSHA respirator and silica medical surveillance meets the health plan, and what a small demo crew actually costs.'),
 ('/group-health-insurance-for-tunneling-contractors','Tunneling and boring',
  'Very small crews working three states from the office. National PPO access is a requirement, not a preference.'),
 ('/group-health-insurance-for-bridge-construction-contractors','Bridge and heavy civil',
  'You already fund benefits through the Davis-Bacon fringe. Paying it into a plan instead of cash lowers payroll tax and comp basis.'),
 ('/group-health-insurance-for-pipeline-contractors','Pipeline contractors',
  'Spreads that assemble, travel and disperse. Cover a defined continuing core rather than every hand on the job.'),
 ('/group-health-insurance-for-industrial-maintenance-contractors','Industrial maintenance and turnarounds',
  'Surge staffing makes you the trade most likely to trip the variable-hour rules and cross 50 FTEs without noticing.'),
 ('/group-health-insurance-for-refrigerated-trucking-companies','Refrigerated trucking',
  'Produce lanes leave the state. A reefer fleet needs national PPO reach and remote enrollment that actually works.'),
 ('/group-health-insurance-for-heavy-haul-trucking-companies','Heavy haul and oversize',
  'An older specialist census costs more - and those are the drivers you cannot replace in a quarter.'),
 ('/group-health-insurance-for-oilfield-trucking-companies','Oilfield trucking',
  'Headcount follows rig count. Build the plan around the core you will keep in a downturn, not the peak roster.'),
 ('/group-health-insurance-for-dump-truck-fleets','Dump truck and aggregate fleets',
  'A small W-2 core inside a fleet of leased owner-operators. Home-daily drivers can use a cheaper regional network.'),
 ('/group-health-insurance-for-delivery-fleets','Last-mile delivery fleets',
  'The youngest and cheapest census in transportation - and the one most likely to cross 50 FTEs without realising.'),
 ('/group-health-insurance-for-freight-brokers','Freight brokers and 3PLs',
  'A young sales floor competing against megabrokers that lead with benefits. Cheaper to cover than owners assume.'),
 ('/group-health-insurance-for-janitorial-companies','Janitorial and building services',
  'Part-time hours, the ACA lookback, and the FPL affordability safe harbour that low-wage employers should be using.'),
 ('/group-health-insurance-for-industrial-cleaning-contractors','Industrial and plant cleaning',
  'Respirator clearance, confined space, and plant contracts that increasingly specify contractor benefits.'),
 ('/group-health-insurance-for-multi-location-retailers','Multi-location retailers',
  'Every store rated on employee home ZIPs, and commonly owned entities aggregated for the 50-employee test.'),
 ('/group-health-insurance-for-shipyard-and-marine-contractors','Shipyard and marine trades',
  'Longshore Act coverage is not health insurance and does not replace it. Here is what it actually leaves uncovered.'),
]
